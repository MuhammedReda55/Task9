...
using Task9_2.Models;

namespace Task9_2.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27ABD7E2D1");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B428B76149");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85DA43A1E0");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229E20CB483");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4E66D69E9");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF598D92DB8");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C6CFA685C");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E616444863D9B").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D368F17FF1");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30CD36F7B12");
